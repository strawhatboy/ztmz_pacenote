...
namespace GameOverlay.Drawing
{
	...
	public class Graphics : IDisposable
	{
		...
		public void drawTextWithBackgroundCentered(Font font, float fontSize, IBrush brush, IBrush background, float x, float y,
            string text)
        {
            var textSize = this.MeasureString(font, fontSize, text);
            this.DrawTextWithBackground(font, fontSize, brush, background, x - textSize.X * 0.5f, y - textSize.Y * 0.5f, text);
        }
	}
}
