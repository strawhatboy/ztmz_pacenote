...
track_data_dr1 = [
    ...
    [19476.5, -4701.11,    'US, Pikes Peak (Alt Surface) - Full Course'],
    [6327.7002, -4700.94,  'US, Pikes Peak (Alt Surface) - Sector 1'],
    [6456.3702, -1122.23,  'US, Pikes Peak (Alt Surface) - Sector 2'],
    [7077.21, 1397.82,     'US, Pikes Peak (Alt Surface) - Sector 3'],
]
...
def export_json(track_data, filename="track_dict.json"):
    for t in track_data:
        key = "{:0.2f}".format(t[0])
...
export_json(track_data)
export_json(track_data_dr1, "track_dict_dr1.json")
